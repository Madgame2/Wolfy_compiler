...
namespace Error {
	...
	*/	
	...
	ERROR errors[ERROR_MAX_ENTRY] =
	{
		...
		ERROR_ENTRY_NODEF(303),ERROR_ENTRY_NODEF(304),ERROR_ENTRY_NODEF(305),ERROR_ENTRY_NODEF(306),ERROR_ENTRY_NODEF(307),ERROR_ENTRY_NODEF(308),ERROR_ENTRY_NODEF(309),
